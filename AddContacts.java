...
public class AddContacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restoredText != null) {
            vehno = prefs.getString("vehno", "No name defined");//"No name defined" is the default value.
    ...
    public void done(View view)
    {
        ...
        firestore.collection("MH49AN2001"+"contacts").add(contact).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
